...
FILE=/ec/res4/scratch/nhd/CERISE/spatial-verif/pre-processing/cryo/snowcover_reformatted_${DATE}.nc
OUT=CRYO_${DATE}.ps
$DP $FILE $OUT 'name="bin_snow"; level="(0,*,*)"; file_type = NETCDF_NCCF;' -v 6

FILE=/ec/res4/scratch/nhd/CERISE/spatial-verif/pre-processing/cryo/cerise_cryo_${DATE}.nc
OUT=CERISE_${DATE}.ps
$DP $FILE $OUT 'name="bin_snow"; level="(0,*,*)"; file_type = NETCDF_NCCF;' -v 6

OUT=CARRA1_${DATE}.ps
FILE=/ec/res4/scratch/nhd/CERISE/spatial-verif/pre-processing/cryo/carra1_cryo_${DATE}.nc
$DP $FILE $OUT 'name="bin_snow"; level="(0,*,*)"; file_type = NETCDF_NCCF;' -v 6
